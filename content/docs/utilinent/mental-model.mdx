...
- Go to [Conditional Rendering](./conditional) when the main issue is branching.
- Go to [Collection Helpers](./collection) when repetition plus fallback is the problem.
- Go to [Async & Visibility](./async) when timing or viewport entry should control output.
- Go to [Composition](./composition) when wrapperless composition is the hard part.
