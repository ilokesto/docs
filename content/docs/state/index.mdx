...
- Use [Middleware](/en/state/reference/middleware) and [Utils](/en/state/reference/utils) when you need logging, validation, persistence, composition, or Immer-style updates.
