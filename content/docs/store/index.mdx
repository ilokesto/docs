...
- [Quick Start](./quick-start): The shortest path from install to a useful store.
- [Mental Model](./mental-model): Why the package stays small and synchronous.
- [API Reference](./api): The exact public surface of the `Store` class.
